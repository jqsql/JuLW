...
public class ZhuanJiaMainFragment extends Fragment
implements OnClickListener,GuanZhuClickItemListener {
	public static final int LOGIN = 0;
	private Activity _this;
	//private View mProgressView;
	private TextView jingxuan,jingcai3,jingcai1;
	...
	public void initView(View view){
		...
		//jingcai1 = (TextView) view.findViewById(R.id.jingcai1);
		jingcai1.setOnClickListener(this);
		initeChildView(view);
	}
	...
	public void onClick(View v) {
		...
		/*case R.id.jingcai1:
			if(isGetting)
				break;
			if(titleType != 3) {//不是竞猜，换成竞猜;
				setMainTitleBack(2);//换成竞猜
				titleType = 3;
				type = 6;
				setTitleBack(0);//换成第一列
				initdata();
	...
	public void setTitleBack(int title) {
		day3.setTextColor(getResources().getColor(R.color.textgrey));
		day3_line.setVisibility(View.INVISIBLE);
		day7.setTextColor(getResources().getColor(R.color.textgrey));
		day7_line.setVisibility(View.INVISIBLE);
		if(titleType == 1) {
			day3.setText("全部");
			day7.setText("近7日胜率");
			day30.setText("近7日人气");
			day30.setTextColor(getResources().getColor(R.color.textgrey));
	...
	public void setMainTitleBack(int choose) {
		...
		int rightJC1 = jingcai1.getPaddingRight();
		int topJC1 = jingcai1.getPaddingTop();
		int bottomJC1 = jingcai1.getPaddingBottom();
		int leftJC1 = jingcai1.getPaddingLeft();

		jingxuan.setTextColor(Color.parseColor("#ffffff"));
		jingxuan.setBackground(null);
		jingxuan.setPadding(leftJX,topJX,rightJX,bottomJX); 
		jingcai3.setTextColor(Color.parseColor("#ffffff"));
		jingcai3.setBackground(null);
		jingcai3.setPadding(leftJC3,topJC3,rightJC3,bottomJC3);
		jingcai1.setTextColor(Color.parseColor("#ffffff"));
		jingcai1.setBackground(null);
		jingcai1.setPadding(leftJC1,topJC1,rightJC1,bottomJC1);  
		if(choose == 0) {
			...
			jingcai3.setBackgroundResource(R.color.white);
			jingcai3.setPadding(leftJC3,topJC3,rightJC3,bottomJC3);  
		} if(choose == 2) {
			jingcai1.setTextColor(getResources().getColor(R.color.textgreen));
			jingcai1.setBackgroundResource(R.drawable.corner24linenone_whitefull);
			jingcai1.setPadding(leftJC1,topJC1,rightJC1,bottomJC1);  
		} 
	}
	@Override

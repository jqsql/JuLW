...
public class Dialog_Pay extends Dialog {
    ...
    public Dialog_Pay(Context context, String title, String content) {
        super(context, 0);
        mContext=context;
        this.title=title;
        this.content=content;
    }
    public Dialog_Pay(Context context, String title, String content, View.OnClickListener itemsOnClick) {
        super(context, 0);
        mContext=context;
        this.title=title;
        this.content=content;

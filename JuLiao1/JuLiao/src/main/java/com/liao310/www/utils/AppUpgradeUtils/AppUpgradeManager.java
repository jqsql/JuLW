...
import com.liao310.www.SplashActivity;
...
import com.liao310.www.utils.PermissionUtils.RxPermissionUtil;
...
public class AppUpgradeManager {
    ...
    private String apkName = "juliao.apk";
    //apk下载文件的路径
    private String downloadApkPath;
    //服务器返回的版本信息
    private VersionDetail latestVersion;

    public AppUpgradeManager(Activity activity, VersionDetail version) {
        mActivity=activity;
    ...
    public static AppUpgradeManager getInstance(Activity activity, VersionDetail version) {
    ...
    public void startDown() {
        ...
        //File targetApkFile = new File(appContext.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), apkName);
        ...
        if (targetApkFile.exists()) {
            ...
            if (info != null) {
                ...
                if (latestVersion.getVersion().equals(versionName)) {
                    installApk();
                    return;
                }
            }
    ...
    private void installApk() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(appContext, "com.juliao310.provider", apkFile);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (DownloadManager.STATUS_SUCCESSFUL == cur.getInt(columnIndex)) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    RxPermissionUtil.getInstance(mActivity).getInstallApk(new Consumer<Boolean>() {
                        @Override

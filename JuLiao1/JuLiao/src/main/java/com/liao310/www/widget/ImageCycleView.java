...
import com.liao310.www.utils.DisplayUtil;
...
public class ImageCycleView extends LinearLayout {
	...
	public void setImageResources(ArrayList<String> imageUrlList ,ArrayList<String> imageTitle,ImageCycleViewListener imageCycleViewListener,int stype,boolean isLocalDrawable){
		...
		for (int i = 0; i < imageCount; i++) {
			...
			//viewGroup2.addView(mTitleViews[i]);//显示标题
		}
	...
	private final class GuidePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int index) {
			...
			if (mImageViews.length==0) {//0张，除数不能�?
				return;
			}
	...
	private class ImageCycleAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			...
			if (isLocalDrawable) {
				...
				xUtilsImageUtils.display(imageView,R.drawable.ic_error,imageUrl);
			}
